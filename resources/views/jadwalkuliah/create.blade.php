            ...
            <div class="card">
                ...
                @endif
                    ...
                    <form method="POST" action="/kurikulum">
                        ...
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">Ruangan</label>
                        ...
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label text-md-right">Hari & Jam</label>

                            <div class="col-md-4">
                                {{ Form::select('hari',$hari,null,['class'=>'form-control'])}}
                            </div>
                            <div class="col-md-2">
                                {{ Form::select('jam_kuliah',$jam,null,['class'=>'form-control'])}}
                            </div>
