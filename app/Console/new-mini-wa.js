...
window.Store ||
  (function () {
      ...
      let t = 0,
        n = [
          ...
          },
          {
            id: "WapQuery",
            conditions: (e) =>
              e.default && e.default.queryExist ? e.default : null,
          },
          {
            id: "CryptoLib",
    ...
    if ("function" == typeof webpackJsonp)
      webpackJsonp([], { parasite: (t, n, i) => e(i) }, ["parasite"]);
    else {
  ...
  (window.WAPI._serializeRawObj = (e) => (e ? e.toJSON() : {})),
  ...
  (window.WAPI.leaveGroup = function (e) {
    return (
      (e = "string" == typeof e ? e : e._serialized), WAPI.getChat(e).sendExit()
    );
  }),
  ...
  (window.WAPI.getMyContacts = function (e) {
    const t = window.Store.Contact.filter((e) => !0 === e.isMyContact).map(
      (e) => WAPI._serializeContactObj(e)
    );
    return void 0 !== e && e(t), t;
  }),
  ...
  (window.WAPI.getAllChatsWithNewMsg = function (e) {
    const t = window.Store.Chat.filter(window.WAPI.haveNewMsg).map((e) =>
  ...
  (window.WAPI.sendImageFromDatabasePicBot = function (e, t, n) {
    var i = window.WAPI.getChatByName("DATABASEPICBOT").msgs.find(
      (t) => t.caption == e
    );
  ...
  (window.WAPI.loadEarlierMessagesTillDate = function (e, t, n) {
    ...
    (x = function () {
      i.msgs.models[0].t > t && !i.msgs.msgLoadState.noEarlierMsgs
        ? i.loadEarlierMsgs().then(x)
        : n();
    }),
      x();
  }),
  ...
  (window.WAPI.getGroupMetadata = async function (e, t) {
    ...
    return (
      void 0 !== n && n.stale && (await window.Store.GroupMetadata.update(e)),
      void 0 !== t && t(n),
      n
    );
  }),
  ...
  (window.WAPI.getGroupAdmins = async function (e, t) {
    const n = (await WAPI._getGroupParticipants(e))
      .filter((e) => e.isAdmin)
      .map((e) => e.id);
    return void 0 !== t && t(n), n;
  }),
  ...
  (window.WAPI.getAllMessageIdsInChat = function (e, t, n, i) {
    ...
    for (const e in s)
      "remove" === e ||
        (!t && s[e].isMe) ||
        (!n && s[e].isNotification) ||
        o.push(s[e].id._serialized);
    return void 0 !== i && i(o), o;
  }),
        ...
        ? (o.sendMessage(t, null, i).then(function () {
            ...
            !(function i() {
              ...
              (e += 1),
                ...
                e > 30
                  ? n(!0)
                  : ((s = 500), new Promise((e) => setTimeout(e, s))).then(i);
            })();
          }),
          !0)
  ...
  (window.WAPI.sendMessageToID = function (e, t, n) {
    try {
      (window.getContact = (e) => Store.WapQuery.queryExist(e)),
        window.getContact(e).then((i) => {
          404 === i.status
            ? n(!0)
            : Store.Chat.find(i.jid)
      ...
      return (
        ...
        void 0 !== n
          ? (firstChat.sendMessage(t).then(function () {
            ...
            !0)
          : (firstChat.sendMessage(t), (firstChat.id = i), !0)
      );
    }
            ...
            !(function o() {
              for (let e = i.msgs.models.length - 1; e >= 0; e--) {
                ...
                if (o.senderObj.isMe && o.body == t)
                  return n(WAPI._serializeMessageObj(o)), True;
              }
              var s;
              (e += 1),
                console.log(e),
                e > 30
                  ? n(!0)
                  : ((s = 500), new Promise((e) => setTimeout(e, s))).then(o);
            })();
          }),
          !0)
        : (i.sendMessage(t), !0)
    ...
    return void 0 !== n
      ? void 0 !== t
        ? (void 0 === n.getLastMsgKeyForAction &&
            (n.getLastMsgKeyForAction = function () {}),
  ...
  (window.WAPI.getCommonGroups = async function (e, t) {
    ...
    for (let t in groups)
      try {
        (participants = await window.WAPI.getGroupParticipantIDs(groups[t].id)),
  ...
  (window.WAPI.getProfilePicSmallFromId = function (e, t) {
    window.Store.ProfilePicThumb.find(e).then(
      function (e) {
        void 0 !== e.img
          ? window.WAPI.downloadFileWithCredentials(e.img, t)
          : t(!1);
      },
      function (e) {
        t(!1);
  ...
  (window.WAPI.getProfilePicFromId = function (e, t) {
    window.Store.ProfilePicThumb.find(e).then(
      function (e) {
        void 0 !== e.imgFull
          ? window.WAPI.downloadFileWithCredentials(e.imgFull, t)
          : t(!1);
      },
      function (e) {
        t(!1);
  ...
  (window.WAPI.deleteMessage = function (e, t, n = !1, i) {
    ...
    return (
      n ? s.sendRevokeMsgs(a, s) : s.sendDeleteMsgs(a, s),
      void 0 !== i && i(!0),
      !0
    );
  }),
  (window.WAPI.checkNumberStatus = function (e, t) {
    return (
      window.Store.WapQuery.queryExist(e)
        .then((e) => {
          if (void 0 !== t) {
            if (void 0 === e.jid) throw 404;
            t(window.WAPI._serializeNumberStatusObj(e));
          }
        })
        .catch((n) => {
          void 0 !== t &&
  ...
  (window.WAPI.waitNewMessages = function (e = !0, t) {
    return (
      window.WAPI._newMessagesCallbacks.push({ callback: t, rmAfterUse: e }), !0
    );
  }),
  ...
  (window.WAPI.sendImage = function (e, t, n, i, o) {
    ...
    return Store.Chat.find(s).then((t) => {
      ...
      a.processAttachments([{ file: s }, 1], t, 1).then(() => {
        a.models[0].sendToChat(t, { caption: i }), void 0 !== o && o(!0);
      });
    });
  }),
  ...
  (window.WAPI.sendVCard = function (e, t) {
    ...
    Array.isArray(t)
      ? (Object.assign(o, { type: "multi_vcard", vcardList: t }), delete o.body)
      : (Object.assign(o, {
          type: "vcard",
  ...
  (window.WAPI.removeParticipantGroup = function (e, t, n) {
    window.Store.WapQuery.removeParticipants(e, [t]).then(() => {
      ...
      if (
        ((checkParticipant = e.participants._index[t]),
        void 0 === checkParticipant)
      )
        return n(!0), !0;
    });
  }),
  (window.WAPI.promoteParticipantAdminGroup = function (e, t, n) {
    window.Store.WapQuery.promoteParticipants(e, [t]).then(() => {
      ...
      return (
        (checkParticipant = e.participants._index[t]),
        void 0 !== checkParticipant && checkParticipant.isAdmin
          ? (n(!0), !0)
          : (n(!1), !1)
      );
    });
